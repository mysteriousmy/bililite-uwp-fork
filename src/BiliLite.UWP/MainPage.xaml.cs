...
namespace BiliLite
{
    ...
    {
        public UIElement TabContainerGrid { get; private set; }
        ...
        private void MessageCenter_MiniWindowEvent(object sender, bool e)
        {
            if (e)
            {
                ...
                AppTitleTextBlock.Visibility = Visibility.Collapsed;
                Window.Current.SetTitleBar(MiniWindowsTitleBar);
            }
            else
            {
                AppTitleTextBlock.Visibility = Visibility.Visible;
                MiniWindowsTitleBar.Visibility = Visibility.Collapsed;
                //Window.Current.SetTitleBar(CustomDragRegion);
                Window.Current.SetTitleBar(TabContainerGrid);
            }
        }
